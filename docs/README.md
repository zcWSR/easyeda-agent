...
| 让 Agent 设计或修复电路 | [SKILL.md](../skills/easyeda-agent/SKILL.md) | 该入口的任务路由与参考 |
| 找到可改参数的相近案例 | [样例索引](../skills/easyeda-agent/references/examples/index.md) | 具体样例的来源、参数及回读 |
| 确认能做什么、不能做什么 | [FEATURES.md](FEATURES.md) | [marketplace-coverage.md](marketplace-coverage.md) |
...
| 维护 Skill 和知识 | [skill-design.md](skill-design.md)、[编写约定](../skills/README.md) | [Agent 协作设计](agent-collaboration.md) |
...
| 查历史检查结论 | [reviews/](reviews/) 与对应报告 | 回到该记录的版本、输入、原始证据和未覆盖项 |
...
| 设计工作流、命令、操作知识 | `skills/easyeda-agent/` | README / 文档索引仅链接；发布包内引用自包含 |
