...
➡️ [`.agents/skills/easyeda-agent/references/pcb-design-rules.md`](../.agents/skills/easyeda-agent/references/pcb-design-rules.md)
...
- 数值型工艺极限的机器可读版：`.agents/skills/easyeda-agent/references/fab-rules-jlcpcb.json`
