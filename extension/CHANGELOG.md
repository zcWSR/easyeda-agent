...
- Include the current unreleased connector fixes for startup bootstrap and explicit netlist-availability reporting. Their live behavior remains subject to this candidate's runtime and project checks.
